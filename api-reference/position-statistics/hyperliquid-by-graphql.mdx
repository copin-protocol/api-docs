---
title: "Position Statistic Hyperliquid List GraphQL"
api: "POST https://api.copin.io/graphql"
description: "Retrieve position statistics for Hyperliquid"
---
...
Query name: searchPositionStatistic
...
<ParamField body="variables" type="object" required>
    ...
    <Expandable title="properties">
        <ParamField body="index" type="string" required>
            The index to search in (e.g., "copin.position_statistics_hyperliquid")
        </ParamField>
...
<ResponseField name="data" type="array">
    ...
    <Expandable title="properties">
        ...
        <ResponseField name="type" type="string">
            Time period for this statistic (e.g., "D7", "D30")
        </ResponseField>
