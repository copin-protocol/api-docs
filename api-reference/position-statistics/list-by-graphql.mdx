...
--header 'Authorization: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6IjB4MTk2YWUxNkE5Mzg3YTNEYzVEZTgxMTQ2N0EyRTM3RDdGZUJlRDMwNCIsInRpbWUiOjE3NDY0OTYxNDA2MDEsImFjY2VzcyI6InpwNVBXTWpVQ0cxNzQ2NDk2MTQwNjAxIiwiaWF0IjoxNzQ2NDk2MTQwLCJleHAiOjE3NDcxMDA5NDB9.vD5a90vP8FmzLqou_eZwopxpqKvflynhK_SpOhRSoss' \
--data '{
  ...
  "variables": {
    ...
    "body": {
      "filter": {
        "and": [
          {"field": "totalTrade", "gte": "2"},
          {"field": "profitRate", "gte": "60"},
          {"field": "pnl", "gte": "100"},
          {"field": "winRate", "gte": "51"},
          {"field": "runTimeDays", "gte": "7"},
          {"field": "protocol", "in": ["GNS"]},
          {"field": "type", "match": "D30"}
        ]
      },
      "sorts": [
        {"field": "realisedPnl", "direction": "desc"}
      ],
      "paging": {
        "size": 12,
        "from": 0
