---
title: "PnL Statistic for Hyperliquid"
api: "POST https://api.copin.io/public/position/statistic-hyperliquid/pnl-statistics"
description: "Retrieve pnl position statistics for hyperliquid"
---
   ...
   Accounts list for filter
    <Expandable title="properties">
        ...
        <ParamField body="protocol" type="string">
            Protocol for filter (HYPERLIQUID)
        </ParamField>
    </Expandable>
</ParamField>
