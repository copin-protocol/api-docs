...
Search and filter Hyperliquid traders using GraphQL, and retrieve PnL statistics.

---

## Position Statistic Hyperliquid List (GraphQL)

**POST** `https://api.copin.io/graphql`

Retrieve position statistics for Hyperliquid via GraphQL.
...
| variables.index | string | Yes | Index to search (e.g., "copin.position_statistics_hyperliquid") |
...
## PnL Statistic for Hyperliquid

**POST** `https://api.copin.io/public/position/statistic-hyperliquid/pnl-statistics`

Retrieve PnL time series data for Hyperliquid accounts.
...
| accounts[].protocol | string | Yes | Protocol (e.g., "KILOEX_BASE", "GMX", "GNS") |
...
```bash
curl --request POST \
--url "https://api.copin.io/public/position/statistic-hyperliquid/pnl-statistics" \
